        ...
        new GoogleStrategy(
            {
                ...
                callbackURL: process.env.GOOGLE_CALLBACK_URL || 'https://ezyedutube-backend.onrender.com/api/auth/google/callback'
            },
            async (_accessToken, _refreshToken, profile, done) => {
                try {
                    ...
                    if (!user) {
                        let username = (profile.displayName || 'user').replace(/\s+/g, '_').toLowerCase();
