...
import { BookOpen, Eye, EyeOff, User, Lock, ArrowRight } from 'lucide-react';
            ...
            >
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-2xl p-8">
                    ...
                    <div className="flex items-center gap-3 mb-5">
                        ...
                        <span className="text-xs text-zinc-400 font-medium">or sign in with username</span>
                        <div className="flex-1 h-px bg-zinc-200 dark:bg-zinc-700" />
                    </div>
                    ...
                    <p className="text-center text-xs text-zinc-400 mt-6">
                        <Link to="/" className="hover:text-orange-400 transition">← Browse without signing in</Link>
                    </p>
                </div>
            </motion.div>
        </div>
